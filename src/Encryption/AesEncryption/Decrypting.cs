...
namespace SafeCrypt.AESDecryption
{
    public class AesDecryption : BaseAesEncryption
    {
        ...
        public async Task<DecryptionData> DeEncryptFromHexStringAsync(DecryptionParameters param)
        {
            var responseData = new DecryptionData();
        ...
        public async Task<DecryptionData> DecryptFromBase64StringAsync(DecryptionParameters param)
        {
            var responseData = new DecryptionData();
